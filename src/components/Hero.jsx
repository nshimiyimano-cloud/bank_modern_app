    ...
    <section id='home' className={`flex
     md:flex-row flex-col ${styles.paddingY}`}>
      ...
      flex-col xl:px-16 px-6 `} >
        ...
        justify-between items-center w-full ">
          ...
          <h1 className="flex-1 font-poppins
           font-semibold ss:text-[72px] text-white ss:leading-[100px]
          leading-[75px]" >
          ...
          <div className="ss:flex hidden md:mr-4 mr-60 ">
            <GetStarted />
        ...
        <h1 className="flex-1 font-poppins
           font-semibold ss:text-[68px] text-white ss:leading-[100px]
          leading-[75px] w-full" >
          ...
          max-w-[470px] mt-5`}>
            Our Tean of experts uses a Methodology to 
            identify the credit cards most likely
            to fit your needs. We examine annual
            percentage rates, anual fees.
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        h-[50%] right-20 blue__gradient pink__gradient" />
